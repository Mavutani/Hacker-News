...
<tr id="pagespace" title="" style="height:10px"></tr><tr><td><table border="0" cellpadding="0" cellspacing="0">
        @foreach ($NewStory as $key => $story)
        @php
        $index = ($NewStory->currentPage() - 1) * $NewStory->perPage() + $loop->iteration;
        @endphp
            <tr class='athing' id='{{ $story->sid}}'>
              ...
              <tr>
                <td colspan="2"></td>
                <td class="subtext">
                  <span class="score" id="score_23201888">{{ $story->score }} points</span> by <a href="user?id=alokrai" class="hnuser">{{ $story->by }}</a> <span class="age"> | <span id="t{{$story->sid}}"></span></span> <span id="unv_23201888"></span> | <a href="hide?id=23201888&amp;goto=news">hide</a> | <a href="item">3&nbsp;comments</a>
        ...
        <tr>
          <td style="color:black;">{{ $NewStory->links('vendor.pagination.default') }}</td>
        </tr>
      </table>
    </td>
  </tr>
